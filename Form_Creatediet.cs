...
{
    public partial class Form_Creatediet : Form
    {
        ...
        private void Form_Creatediet_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    if (rowsAffected > 0)
                    {
                        //string username = GetLoggedInUsername(); // You need to implement this method to get the currently logged-in user
                        string auditAction = $"New booking added by '{userID}'.";
